...
./robogen-server 8000 &>/dev/null &
./robogen-evolver $RANDOM testRunResults/objective_based_complexity_cost/ ../projectSimulations/dummy_confs/evolConf0.txt --save-all --complexity-cost
...
./robogen-server 8001 &>/dev/null &
./robogen-evolver $RANDOM testRunResults/novelty_complexity_cost/ ../projectSimulations/dummy_confs/evolConf1.txt --save-all --complexity-cost
